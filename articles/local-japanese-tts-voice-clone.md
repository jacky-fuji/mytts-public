...
:::message alert
本稿は、2026年6月時点のローカル環境と公開モデルを前提に、個人が自分自身の声だけを対象に行った検証記録である。評価対象は筆者本人の声のみ、聴感評価者も筆者1名のみ、つまりサンプル数は n=1 である。査読済み論文、製品評価レポート、第三者機関によるベンチマーク、専門家の鑑定ではなく、結果を統計的に一般化することは意図していない。
:::
