...
:::message
音声サンプルはGitHub Pages側の[試聴ページ](https://jacky-fuji.github.io/mytts-public/)に分離しています。補足資料と公開可能なスクリプトは[GitHubリポジトリ](https://github.com/jacky-fuji/mytts-public)にまとめています。Zenn本文は検証手順、結果、音響分析を中心にしています。
:::
